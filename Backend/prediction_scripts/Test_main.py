...
bat_model = joblib.load(os.path.join(base_dir, 'Models', 'bat_model_test.pkl'))
bowl_model = joblib.load(os.path.join(base_dir, 'Models', 'bowl_model_Test.pkl'))

# === Load data ===
players_df = pd.read_csv(os.path.join(base_dir, 'Data', 'players.csv'))
batting_df = pd.read_csv(os.path.join(base_dir, 'Data', 'Test_Bat.csv'))
bowling_df = pd.read_csv(os.path.join(base_dir, 'Data', 'Test_Ball.csv'))
