...
def predict_team(match_type):
    ...
    # Ensure we look in the prediction_scripts folder
    base_dir    = os.path.dirname(os.path.abspath(__file__))
    script_name = script_mapping[match_type]
    script_path = os.path.join(base_dir, 'prediction_scripts', script_name)
    ...
    try:
        ...
        result = subprocess.run(
            ...
            text=True,
            check=True,
            cwd=base_dir  # Set working directory to Backend folder
        )
